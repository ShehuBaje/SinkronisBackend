  ...
  definition: {
    ...
    components: {
      ...
      schemas: {
        ...
        EmployeeRecentPayslip: { type: "object", nullable: true, properties: { id: { type: "string" }, period: { type: "string" }, grossPay: { type: "number" }, totalDeductions: { type: "number" }, netPay: { type: "number" }, currency: { type: "string" }, status: { type: "string", enum: ["APPROVED", "PAID"] }, availableForDownload: { type: "boolean", description: "False until an employee-owned download endpoint exists." } } },
