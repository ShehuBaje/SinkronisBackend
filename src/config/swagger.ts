...
const options: swaggerJSDoc.Options = {
  definition: {
    ...
    paths: {
      ...
      [`${env.API_PREFIX}/accounting/invoices`]: { get: { tags: ["Accounting - Invoices"], summary: "List invoices", description: "Tenant-scoped search, client/agent/project/status/date filters and pagination. OVERDUE includes past-due unpaid SENT invoices.", security: [{ bearerAuth: [] }], parameters: ["search", "clientId", "agentId", "projectId", "status", "fromDate", "toDate", "page", "limit"].map((name) => ({ in: "query", name, schema: { type: name === "page" || name === "limit" ? "integer" : "string" } })), responses: { "200": { description: "Invoice rows and pagination" }, "401": { description: "Unauthenticated" }, "403": { description: "Accounting entitlement or permission unavailable" } } }, post: { tags: ["Accounting - Invoices"], summary: "Create draft invoice", description: "Backend resolves catalogue snapshots and authoritative VAT, then calculates subtotal, VAT and total.", security: [{ bearerAuth: [] }], requestBody: { required: true, content: { "application/json": { schema: { type: "object", required: ["clientId", "dueDate", "items"], properties: { clientId: { type: "string" }, assignedAgentId: { type: "string", nullable: true }, projectId: { type: "string", nullable: true }, dueDate: { type: "string", format: "date" }, notes: { type: "string" }, items: { type: "array", minItems: 1, items: { type: "object", required: ["quantity"], properties: { catalogueItemId: { type: "string" }, description: { type: "string" }, quantity: { type: ["string", "number"] }, unitPrice: { type: ["string", "number"] }, vatApplicable: { type: "boolean" } } } } } } } } }, responses: { "201": { description: "Draft invoice with frozen lines and status history" }, "400": { description: "Validation error" }, "404": { description: "Tenant-owned relation not found" } } } },
