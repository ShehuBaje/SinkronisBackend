...
const options: swaggerJSDoc.Options = {
  definition: {
    ...
    paths: {
      ...
      [`${authBase}/tenant-invitations/accept`]: { post: { tags: ["Auth"], summary: "Accept a Tenant Admin workspace invitation", description: "Consumes a one-time, seven-day tenant invitation and establishes the initial password under the active password policy. This is separate from forgot-password recovery.", requestBody: { required: true, content: { "application/json": { schema: { $ref: "#/components/schemas/AcceptTenantInvitationBody" } } } }, responses: { "200": { description: "Tenant Admin password created" }, "400": { description: "Invalid, expired, consumed invitation or password-policy failure" }, "500": { description: "Unexpected error" } } } },
