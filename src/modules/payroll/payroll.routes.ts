...
payrollRouter.post("/wallet/obligations/:obligationId/pay", authorize("payroll:statutory:update"), validate({ params: payrollWalletObligationParamsSchema, body: payrollSettlementSchema }), asyncHandler(payPayrollWalletObligationController));
...
payrollRouter.post("/pension/remittances/:id/remit", authorize("payroll:statutory:update"), validate({ params: payrollPensionParamsSchema, body: payrollPensionMarkRemittedSchema }), asyncHandler(markPayrollPensionRemittedController));
