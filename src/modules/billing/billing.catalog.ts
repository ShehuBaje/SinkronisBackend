...
export type BillingPricingModel = "FIXED" | "FIXED_BUNDLE";
...
export const billingPlans: readonly BillingPlanDefinition[] = [
  {
    key: "hris", name: "HRIS", monthlyCost: 80000, pricingModel: "FIXED", yearlyCost: 960000, includedModules: ["hris"],
  ...
  {
    key: "payroll", name: "Payroll", monthlyCost: 10000, pricingModel: "FIXED", yearlyCost: 120000, includedModules: ["payroll"],
  ...
  {
    key: "accounting", name: "Accounting", monthlyCost: 80000, pricingModel: "FIXED", yearlyCost: 960000, includedModules: ["accounting"],
  ...
  {
    key: "all-in-one", name: "All-in-One Suite", monthlyCost: 150000, pricingModel: "FIXED_BUNDLE", yearlyCost: 1800000, includedModules: ["hris", "payroll", "accounting"],
