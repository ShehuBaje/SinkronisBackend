...
import { EXPORT_QUEUE_NAME, LIFECYCLE_QUEUE_NAME, NOTIFICATION_QUEUE_NAME, PAYROLL_QUEUE_NAME } from "./index";
...
export const initializeWorkers = () => {
  ...
  const payrollWorker = new Worker(PAYROLL_QUEUE_NAME, async (job) => {
    ...
    if (job.name === "payroll-recovery") return reconcileProcessingPayRuns();
